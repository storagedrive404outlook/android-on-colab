...
curl -L -o lite7.qcow2 https://app.vagrantup.com/thuonghai2711/boxes/WindowsQCOW2/versions/1.1.5/providers/qemu.box
echo "Windows server 2008 x64 Lite On Google Colab"
